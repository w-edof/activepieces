...
export const createAttendee = createAction({
  auth: wedofAuth,
  name: 'createAttendee',
  displayName: "Créer un apprenant",
  description: "Permet de créer un nouvel apprenant",
  props: {
    ...
    email: Property.ShortText({
      displayName: 'Email',
      description: "Email de l'apprenant / candidat",
      required: true,
    }),
    phoneNumber: Property.ShortText({
      displayName: 'Numéro de portable',
      description: "téléphone portable de l'apprenant / candidat - obligatoire si Téléphone fixe n'est pas renseigné", 
      required: false,
    }),
    phoneFixed: Property.ShortText({
      displayName: "Téléphone fixe",
      description: "téléphone fixe de l'apprenant / candidat  - obligatoire si Téléphone portable n'est pas renseigné",
      required: false,
    }),
  ...
  async run(context) {
    const message = {
      ...
      phoneNumber: context.propsValue.phoneNumber ?? null,
      phoneFixed: context.propsValue.phoneFixed ?? null,
